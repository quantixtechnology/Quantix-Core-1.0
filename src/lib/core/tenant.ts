// ============================================================================
// Quantix Core Platform — Multi-Tenant Architecture
// "Run Your Business Smarter" — www.quantixtechnology.in
//
// Row-Level Isolation via businessId + storeId.
// MANAGED PLATFORM: Super Admin has no businessId constraint.
//
// Server-side only — do NOT import React components from this file.
// ============================================================================

import { db } from '@/lib/db';
import type { Role, BusinessType, OrderType } from './types';
import { isPlatformRole } from './rbac';
...
/** Tenant query filter for scoping Prisma queries */
 ...
 * Each business type gets a different set of enabled capabilities.
 */
...
// ============================================================================
// TENANT RESOLUTION — Resolve full context from DB
// ============================================================================
...
export function businessSupportsOrderType(
  ...
  switch (orderType) {
    case 'DELIVERY':
      return features.hasDelivery;
    case 'PICKUP':
      return features.hasPickup;
    case 'DINE_IN':
      return features.hasDineIn;
    case 'POS':
      return features.hasPOS;
    case 'SUBSCRIPTION':
      return features.hasSubscription;
    case 'PICKUP_AND_DELIVERY':
      return features.hasPickupAndDelivery;
    default:
      return false;
  }
}
