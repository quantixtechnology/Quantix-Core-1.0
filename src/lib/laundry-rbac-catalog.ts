...
export const SYSTEM_ROLES: SystemRoleDef[] = [
  ...
  { code: "STORE_MANAGER", name: "Store Manager", description: "Operational management across store + processing.", screens: () => [
    ...
    { screenKey: "laundry.new_order", level: Level.CREATE },
    { screenKey: "laundry.garment_lookup", level: Level.CREATE },
    { screenKey: "laundry.order_detail", level: Level.CREATE },
    { screenKey: "laundry.inbox", level: Level.CREATE },
    ...
    { screenKey: "laundry.delivery_executives", level: Level.CREATE },
    { screenKey: "laundry.mobile_apps", level: Level.CREATE },
    { screenKey: "laundry.roles", level: Level.CREATE },
  ...
  { code: "COUNTER_EXECUTIVE", name: "Counter Executive", description: "Order creation and customer handling.", screens: () => [
    ...
    { screenKey: "store_ops.pickup_scheduler", level: Level.CREATE },
    { screenKey: "store_ops.pickup_bags", level: Level.CREATE },
    { screenKey: "store_ops.dispatch_center", level: Level.CREATE },
    { screenKey: "store_ops.delivery_assignments", level: Level.CREATE },
    { screenKey: "store_ops.bag_management", level: Level.CREATE },
  ]},
