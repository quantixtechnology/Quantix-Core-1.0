...
export { scannerStatus, physicalConnection, PHYSICAL_CONNECTION_UNKNOWN, PHYSICAL_CONNECTION_NOTE, NOT_VERIFIED_DETAIL } from "./scanner-status"
export type { ScannerStatus, ScannerVerification } from "./scanner-status"
