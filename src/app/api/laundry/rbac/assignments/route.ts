// GET    /api/laundry/rbac/assignments?businessId=  — employee → role list
// POST   /api/laundry/rbac/assignments               — assign a role (one/user)
// DELETE /api/laundry/rbac/assignments?businessId=&userId=  — remove assignment
...
export async function POST(request: Request) {
  ...
  // One active role per user — upsert so a role change takes effect immediately.
