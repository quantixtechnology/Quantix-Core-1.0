...
import { Globe, Server, Shield, CheckCircle2, AlertCircle, Clock, ExternalLink } from 'lucide-react';
            ...
            <div className="overflow-x-auto">
              <table className="w-full text-xs">
                ...
                <tbody className="divide-y divide-slate-50">
                  {domains.map(dom => (
                    <tr key={dom.id} className="hover:bg-slate-50 transition-colors duration-150">
      ...
      <div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3">
          {deployments.map(dep => {
            ...
            return (
              <Card key={dep.id} className="hover:shadow-md transition-shadow duration-200">
                <CardContent className="p-4">
