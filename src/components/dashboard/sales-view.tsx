    ...
    <div className="space-y-6 animate-in fade-in duration-300">
      ...
      <div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          {salesTeam.map(rep => (
            <Card key={rep.id} className="hover:shadow-md transition-shadow duration-200">
                  ...
                  <div className="flex-1">
                    ...
                    <div className="mt-2">
                      ...
                      <div className="w-full h-1.5 bg-slate-100 rounded-full overflow-hidden">
                        <div className="h-full bg-emerald-500 rounded-full transition-all duration-300" style={{ width: `${Math.min(100, rep.achieved / rep.target * 100)}%` }} />
                      </div>
                    </div>
                  </div>
                </div>
