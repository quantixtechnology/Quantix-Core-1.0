...
const NAV_GROUPS: NavGroup[] = [
  ...
  },
  {
    ...
    items: [
      { key: "pickup-scheduler", label: "Pickup Assignments", icon: Truck, page: "pickup-scheduler", minRank: 2, perm: "laundry.orders.view" },
      { key: "delivery-assignments", label: "Delivery Assignments", icon: Truck, page: "delivery-assignments", minRank: 2, perm: "laundry.orders.view" },
