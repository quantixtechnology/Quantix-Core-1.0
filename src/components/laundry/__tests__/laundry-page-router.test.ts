...
const ROUTE_MAP: RouteEntry[] = [
  ...
  { pages: ["ws-dry"], component: "LaundryWorkstation(stage=DRY)" },
  { pages: ["ws-dryclean"], component: "LaundryWorkstation(stage=DRYCLEAN)" },
  { pages: ["ws-iron"], component: "LaundryWorkstation(stage=IRON)" },
  { pages: ["ws-fold"], component: "LaundryWorkstation(stage=FOLD)" },
  { pages: ["ws-qc"], component: "LaundryWorkstation(stage=QC)" },
  { pages: ["ws-pack"], component: "LaundryWorkstation(stage=PACKED)" },
]
