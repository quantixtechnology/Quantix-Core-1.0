...
// transparently attaches that token as `Authorization: Bearer …` to same-origin
// /api/laundry requests.
//
// Scope is deliberately narrow:
//   • Only requests whose URL contains "/api/laundry" are touched.
  ...
  useEffect(() => {
    ...
    window.fetch = (input: RequestInfo | URL, init?: RequestInit): Promise<Response> => {
      try {
        ...
        // Only augment plain string/URL calls to the Laundry OS API. Request
        // objects and non-laundry URLs pass through unchanged.
